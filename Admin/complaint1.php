            ...
            <div class="page-content">
                ...
                if ($getall && mysqli_num_rows($getall) > 0) {
                    while ($row = mysqli_fetch_assoc($getall)) {
                        ...
                        // A staff member can only edit:
                        // 1. Unassigned complaints (NULL)
                        // 2. Complaints assigned to THEMSELVES
                        // Admins can edit everything.
                        $can_edit = false;
                        if ($logged_in_user_role == 'admin' || $assigned_staff_id === NULL || $assigned_staff_id == $logged_in_staff_id) {
                            $can_edit = true;
                        }
                        
                        // Disable if closed or withdrawn
                        if ($complaint_status == "Closed" || $complaint_status == "Withdrawn") {
                            $can_edit = false; 
                        }
                ?>
                        <article class="card mt-4 shadow-sm">
                            ...
                            <div class="card-body mt-3">
                                ...
                                <div class="row align-items-end">
                                    ...
                                    <!-- Urgency Column -->
                                    <div class="col-md-3" style="align-self: baseline;">
                                        ...
                                        <select onchange='updateData(this, "<?php echo $complaint_id; ?>","urgency_level", "complaint", "complaint_id")' 
                                                ...
                                                class='form-select' 
                                                name="urgency_level"
                                                <?php echo ($complaint_status == "Closed" || $complaint_status == "Withdrawn" || $logged_in_user_role != 'admin' || !$can_edit) ? 'disabled' : ''; ?>>
