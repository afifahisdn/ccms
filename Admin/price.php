    ...
    <div id="app">
        ...
        <div id="main">
            ...
            <div class="row">
                ...
                <div class="col-lg-2">
                    <button class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#PriceModal"> Add New</button>
                </div>
            </div>
                        ...
                        <table id="datatable" class="table table-bordered">
                            ...
                            <tbody>
                                ...
                                ?>
                                    <tr>
                                        <td>
                                            <select onchange="updateData(this, '<?php echo $price_id; ?>', 'start_area', 'price_table', 'price_id');" id="start_area_<?php echo $price_id; ?>" class='form-control norad tx12' name="start_area">
                                                <?php
                                        ...
                                        <td>
                                            <select onchange="updateData(this, '<?php echo $price_id; ?>', 'end_area', 'price_table', 'price_id');" id="end_area_<?php echo $price_id; ?>" class='form-control norad tx12' name="end_area">
                                                <?php
                                                $getallCat = getAllArea();
                                                while ($row2 = mysqli_fetch_assoc($getallCat)) {
                                                ?>
                                        ...
                                        <td>
                                            <input type="number" id="price_<?php echo $price_id; ?>" name="price" required="required" onchange="updateData(this, '<?php echo $price_id; ?>', 'price', 'price_table', 'price_id');" value="<?php echo $row["price"]; ?>" class="form-control col-md-7 col-xs-12">
                                        </td>
            ...
            <div class="modal-content">
                ...
                <form action="" method="post" id="basicform" data-parsley-validate="" enctype="multipart/form-data">
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="button" onclick="addPrice(this.form)" name="submit" class="btn btn-primary">Save changes</button>
                    </div>
                </form>
            </div>
        </div>
