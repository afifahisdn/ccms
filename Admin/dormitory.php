...
* admin/dormitory.php
*
* Manages college dormitories/buildings.
...
<body>
                ...
                <div class="col-lg-10">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Dormitory List</li>
                        </ol>
                    </nav>
                </div>
                <div class="col-lg-2 text-lg-end">
                    <button class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#DormitoryModal"> Add New</button>
                </div>
            </div>
                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                                <tr>
                                                    ...
                                                    <td><?php echo htmlspecialchars($row["dormitory_code"]); ?></td>
                                                    <td>
                                                        <!-- Updated deleteData parameters -->
                                                        <button type="button" onclick="deleteData(<?php echo $dormitory_id; ?>, 'dormitory', 'dormitory_id')" class="btn btn-danger btn-sm">
    ...
    <!-- Add Dormitory Modal -->
    <div class="modal fade" id="DormitoryModal" tabindex="-1" aria-labelledby="DormitoryModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="DormitoryModalLabel">Add New Dormitory</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <form id="addDormitoryForm" method="post" onsubmit="return false;">
                    ...
                    <div class="modal-footer">
                        ...
                        <!-- Calls addDormitory from add.js -->
                        <button type="button" onclick="addDormitory(document.getElementById('addDormitoryForm'))" name="submit" class="btn btn-primary">Save changes</button>
                    </div>
                </form>
            </div>
        </div>
