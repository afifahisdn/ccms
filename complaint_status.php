...
* Public page to check the status of a single complaint using a GET request with complaint_id.
*/
...
<head>
    ...
    <!-- Custom CSS (Copied from complaints.php for consistency) -->
    <style>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-12 text-right">
                        ...
                        <a href="login.php" class="quick-link d-inline-block">Login</a>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container" style="margin-top: 5rem;">
            <div class="row justify-content-center">
                <div class="col-md-10 mb-5">
                    ...
                    // Ensure getComplaintByID joins with dormitory
                    ...
                    ?>
                        <article class="card shadow-sm complaint-card status-<?php echo $complaint_status; ?>">
                            ...
                            <div class="card-body">
                                ...
                                <div class="row mb-3 complaint-details">
                                    <div class="col-md-6">
                                        ...
                                        <strong>Room:</strong> <?php echo htmlspecialchars($row['room_number']); ?><br>
                                        <strong>Submitted:</strong> <?php echo date("d M Y, H:i", strtotime($row["created_at"])); ?>
                                    </div>
                                    <div class="col-md-6">
                                        <strong>Category:</strong> <?php echo ucwords(str_replace('_', ' ', htmlspecialchars($row['complaint_category']))); ?><br>
                                        <strong>Urgency:</strong> <span class="urgency-<?php echo strtolower(htmlspecialchars($row['urgency_level'])); ?>"><?php echo ucfirst(htmlspecialchars($row['urgency_level'])); ?></span><br>
